  ...
  return (
    <div className="containerProjects">
        ...
        <div className='projectsGrid'>
          ...
          <ProjectCards link={"/projects/desiderata"} title={"oleana jewelry"} description={"shooting"} img={"https://res.cloudinary.com/dpsobnvtv/image/upload/f_auto/v1683677536/Frenzy/Rectangle_3852d_ahsptw.png"} pageWidth={width}/>
        ...
        <div className="buttonMoreProjects"><Button text={"MÁS PROYECTOS"}/></div>
    </div>
  )
}
